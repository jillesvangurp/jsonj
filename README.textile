...
JsonJ provides a few classes that extend Java's Collections framework. Extending the Collections framework means using a familiar, and powerful API that most Java engineers already know how to use. The following classes are provided:
