...
pre. 
JsonObject o=object()
  .put("aList",array(1,2,object()
    .put("meaningoflife",42),"a String")
    .put("note","that the builder calls get() for you if you pass in another builder")
  )
  .put("another", "element")
  .put("set",set(1,2,3)
  .put("lists,array(array(1,2),array(3,4)))
  .get() 

p. The builder class also provides methods to facilitate converting from existing Maps, Lists, and other objects. For example, the fromObject method takes any Java object and tries to do the right thing.
