...
If you use jruby, you can seemlessly integrate jsonj using this module "jruby-integration":"https://github.com/jillesvangurp/jsonj-integration". This is nice if you are mixing java code that uses JsonJ, with ruby code.
